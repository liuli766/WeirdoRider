				...
				<swiper-item class="swiper-item" v-for="(page, index) in homenavList" :key="index">
					<view class="component">
						...
						<view class="page-item">
							<distribution class="page-item" v-for="(list,i) in 3" :key="i" v-if='tabIndex===0' @tap="GodistribuDetail"></distribution>
						</view>
						<!-- 已完成 -->
						<view class="page-item">
							<ordercomplted class="page-item" v-if='tabIndex===3' @tap="GoOrderComDetail">
						...
						<!-- 待取货 -->
						<view class="page-item">
							<ordercomplted class="page-item" v-if='tabIndex===1' @tap="GoPickupDetail">
						...
						<!-- 配送中 -->
						<view class="page-item">
							<ordercomplted class="page-item" v-if='tabIndex===2' @tap="GoPickupDetail">
								<text class="color3434 bold font32" slot='tit'>顾客已等待3分钟</text>
								<text class="color333 font26 font500" slot='concat'>距离：1.8km</text>
								<view class="flex text_cen" slot='btn'>
									<view class="sjbtn font500" @tap.stop="Concat">联系商家</view>
