		...
		<view class="bannerbg" >
			...
			<view v-show="navnum===0">
				...
				<view class="talent-list-box">
					...
					<view class="talent-list-item flex flex_be flex_al-cen" v-for="(item,i) in Talent" :key="i">
		...
		data() {
			return {
				...
				Talent:[
					{
						status:1,
						head:require('../../../static/img/head.png'),
						name:'我是一名小保安',
						numberval:1240
					},
					{
